    ...
    func mockVisitData() {
        ...
        for linePoint in testDatas {
            ...
            if(accuracy < 20.0) {
                ...
                let visitToSave = VisitModel(visitId: id, arrivalDate: arrivalDate, departureDate: departureDate, latitude: lat, longitude:  lng, dateCaptured:Date() , accuracy: accuracy)
