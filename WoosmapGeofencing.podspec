Pod::Spec.new do |s|
  ...
  s.source_files = 'WoosmapGeofencing/Sources/WoosmapGeofencing/*.swift', 'WoosmapGeofencing/Sources/WoosmapGeofencing/Business Logic/*.swift', 'WoosmapGeofencing/Sources/WoosmapGeofencing/Config/*.swift', 'WoosmapGeofencing/Sources/WoosmapGeofencing/Config/*.json'
